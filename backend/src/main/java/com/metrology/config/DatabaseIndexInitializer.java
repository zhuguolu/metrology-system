...
public class DatabaseIndexInitializer implements ApplicationRunner {
    ...
    public void run(ApplicationArguments args) {
        List<IndexDefinition> indexes = List.of(
                ...
                new IndexDefinition("audit_records", "idx_audit_records_status_submitted_at", "status, submitted_at"),
                new IndexDefinition("audit_records", "idx_audit_records_submitter_submitted_at", "submitted_by, submitted_at"),
                new IndexDefinition("audit_records", "idx_audit_records_entity", "entity_type, entity_id"),
                new IndexDefinition("audit_workflow_steps", "idx_audit_workflow_steps_module_order", "module_name, step_order"),
                new IndexDefinition("webdav_mounts", "idx_webdav_mounts_user_created", "user_id, created_at"),
                new IndexDefinition("departments", "idx_departments_parent_sort_name", "parent_id, sort_order, name"),
                new IndexDefinition("device_statuses", "idx_device_statuses_sort_name", "sort_order, name"),
                new IndexDefinition("user_permissions", "idx_user_permissions_user", "user_id"),
                new IndexDefinition("user_settings", "idx_user_settings_user", "user_id"),
